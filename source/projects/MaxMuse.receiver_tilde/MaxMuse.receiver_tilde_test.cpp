...
#include "MaxLSL.receiver_tilde.cpp"    // need the source of our object so that we can access it
...
SCENARIO("object produces correct output") {
    ...
    GIVEN("An instance of our object") {
        ...
        test_wrapper<receiver_tilde> an_instance;
        receiver_tilde&              my_object = an_instance;
